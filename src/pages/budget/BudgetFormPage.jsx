    ...
    <div className="budget-form-page">
      <div className="page-header">
        <div>
          ...
          <h1 className="page-title" id="budget-form-title">
      ...
      <div className="budget-form-container">
        <form className="budget-form" onSubmit={handleSubmit} id="budget-form">
          {error && (
        ...
        <div className="budget-preview" id="budget-preview">
          ...
          <div className="preview-stats">
            <div className="preview-stat">
              ...
              <div>
                <span className="preview-stat-value">{preview.totalDays}</span>
                <span className="preview-stat-label">Total Hari</span>
              </div>
            </div>

            <div className="preview-stat">
              <span className="preview-stat-icon preview-stat-working">💼</span>
              <div>
                <span className="preview-stat-value">{preview.workingDays}</span>
                <span className="preview-stat-label">Hari Kerja</span>
              </div>
            </div>

            <div className="preview-stat">
              <span className="preview-stat-icon preview-stat-weekend">🌙</span>
              <div>
                <span className="preview-stat-value">{preview.weekendDays}</span>
          ...
          <div className="preview-note">
            ...
            Budget harian = Total Budget ÷ Hari Kerja. Weekend mendapat budget Rp 0 (carry-over tetap aktif).
          </div>
        </div>
      </div>
    </div>
